...
class CustomField extends BaseEntity
{
    ...
    public function getAll(): CustomFieldListDTO
    {
        $this->validateApiKey();
    ...
    public function create(string $name, CustomFieldType $fieldType): CustomFieldDTO
    {
        $this->validateApiKey();
    ...
    public function update(string $id, string $name, ?CustomFieldType $fieldType): CustomFieldDTO
    {
        $this->validateApiKey();
        $this->validateName($name);
