...
class Contact extends BaseEntity
{
    ...
    public function getById(string $contactId): ContactDTO
    {
        $this->validateApiKey();
     ...
     */
    public function createOrUpdate(array $contacts, ?array $listIds = null): JobDTO
    {
        $this->validateApiKey();
     ...
     * @return JobDTO
     */
    public function delete(?array $contactIds = null, bool $deleteAll = false): JobDTO
    {
        $this->validateApiKey();
        ...
        $response = $this->getSendgridClient()->sendRequest(
            ...
            endpoint: self::BASE_ENDPOINT . (
                $deleteAll ? '?delete_all_contacts=true' : '?ids=' . implode(',', $contactIds)
            )
        );
     ...
     * @param string $fileType The type of file: 'csv'
    ...
    public function import(
        ...
        $uploadResponse = $this->getSendgridClient()->sendRequest(
            method: RequestType::PUT->value,
     ...
     * @param string[]|null $listIds Array of list IDs to add contacts to
     * @param string[]|null $fieldMappings Custom field mappings (for CSV files)
     * @param string|null $fileType Explicitly specify 'csv' (required for URLs without clear extensions)
     * @return ContactImportDTO
     * @throws \InvalidArgumentException
    ...
    public function getImportStatus(string $jobId): ContactImportStatusDTO
    {
        $this->validateApiKey();
    ...
    public function search(string $query): ContactSearchDTO
    {
        $this->validateApiKey();
    ...
    public function getCount(): ContactCountDTO
    {
        $this->validateApiKey();
    ...
    public function exportStatus(string $jobId): ContactExportStatusDTO
    {
        $this->validateApiKey();
    ...
    /**
     * @return ContactAllExportsStatusDTO[]
     */
    public function getAllExportsStatus(): array
    {
        $this->validateApiKey();
    ...
    public function deleteIndentifier(string $contactId, ContactIdentifierType $identifierType, string $identifierValue): JobDTO
    {
        $this->validateApiKey();
